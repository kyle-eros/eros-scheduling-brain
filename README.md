...
graph LR
    A[📧<br/>Performance Data<br/>Ingestion]
    B[🧠<br/>AI Analysis<br/>Engine]
    C[📅<br/>Smart Scheduling<br/>Optimization]
    D[✍️<br/>Caption Creation<br/>Generation]
    E[🚀<br/>Distribution<br/>Deployment]
    F[📊<br/>Results Analysis<br/>Learning Loop]
    ...
    style A fill:#4285F4,stroke:#1967D2,stroke-width:4px,color:#fff,rx:10,ry:10
    style B fill:#FF6F00,stroke:#E65100,stroke-width:4px,color:#fff,rx:10,ry:10
    style C fill:#00C853,stroke:#00A344,stroke-width:4px,color:#fff,rx:10,ry:10
    style D fill:#669DF6,stroke:#4285F4,stroke-width:4px,color:#fff,rx:10,ry:10
    style E fill:#00D9FF,stroke:#00ACC1,stroke-width:4px,color:#fff,rx:10,ry:10
    style F fill:#9C27B0,stroke:#7B1FA2,stroke-width:4px,color:#fff,rx:10,ry:10
    ...
    linkStyle 3 stroke:#669DF6,stroke-width:3px
    linkStyle 4 stroke:#00D9FF,stroke-width:3px
    linkStyle 5 stroke:#9C27B0,stroke-width:3px
```
